...
window.onload = function initCube() {
    ...
    document.getElementById("applyTranslate").onclick = function () {
        translate[0] = parseFloat(document.getElementById("translateX").value) || 0;
        translate[1] = parseFloat(document.getElementById("translateY").value) || 0;
        translate[2] = parseFloat(document.getElementById("translateZ").value) || 0;
        gl.uniform3fv(translateLoc, translate);
    }
