...
window.onload = function initCube() {
    ...
    document.getElementById("applyScale").onclick = function () {
        scale[0] = parseFloat(document.getElementById("scaleX").value) || 1;
        scale[1] = parseFloat(document.getElementById("scaleY").value) || 1;
        scale[2] = parseFloat(document.getElementById("scaleZ").value) || 1;
        gl.uniform3fv(scaleLoc, scale);
    }
